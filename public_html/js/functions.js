...
(function($){
	...
	SEMICOLON.widget = {
		...
		notifications: function( position, type, message, close ){
			toastr.clear();
			var notifyPosition = position,
				notifyType = type,
				notifyMsg = message,
				notifyCloseButton = close;
			...
			if( notifyType == 'warning' ) {
				notifyMsg = '<i class="icon-warning-sign"></i> ' + notifyMsg;
				toastr.warning(notifyMsg);
			} else if( notifyType == 'error' ) {
				notifyMsg = '<i class="icon-remove-sign"></i> ' + notifyMsg;
				toastr.error(notifyMsg);
			} else if( notifyType == 'success' ) {
				notifyMsg = '<i class="icon-ok-sign"></i> ' + notifyMsg;
				toastr.success(notifyMsg);
			} else {
				notifyMsg = '<i class="icon-info-sign"></i> ' + notifyMsg;
