      ...
      <section id="container" >         
                 ...
                 <h5 class="centered"><?php echo ucwords($session['username']); ?></h5>
                  ...
                  <li class="sub-menu">
                     ...
                     <ul class="sub">
                        ...
                        <li class="active"><a href="<?php echo site_url('admin/quiz/archive'); ?>">Archive</a></li>
                     </ul>
                  </li>
                  <li class="sub-menu">
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <h3 class="page-side-heading"><i class="fa fa-angle-right"></i> <a href="<?php echo site_url('admin/quiz'); ?>">Quiz</a> <i class="fa fa-angle-right"></i> <a href="<?php echo site_url('admin/quiz/archive'); ?>">Archive</a></h3>
               ...
               if (empty($quiz)) {
                  ...
                  echo '<h4>No Quiz to display in Archive!</h4>';
                  echo '</div>';
                  echo '</div>';
                  echo '</div>';
               } else {
                  ...
                  foreach ($quiz as $q) {
                     ...
                     echo '</div>';
                     echo '<div class="col-md-6">';
                     echo '<p class="small mt">Enrolled users</p>';
                     echo '<p>'.$quiz_enrolled[$q->id].'</p>';
                     echo '</div>';
                     echo '</div>';
                     echo '<div class="row">';
                     echo '<div class="col-md-6">';
