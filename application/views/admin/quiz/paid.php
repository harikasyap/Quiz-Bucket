      ...
      <section id="container" >         
               ...
               <ul class="sidebar-menu" id="nav-accordion">
                 ...
                 <h5 class="centered"><?php echo ucwords($session['username']); ?></h5>
                  ...
                  <li class="sub-menu">
                     ...
                     <ul class="sub">
                        <li class="active"><a href="<?php echo site_url('admin/quiz/paid'); ?>">Paid Quiz</a></li>
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <h3 class="page-side-heading"><i class="fa fa-angle-right"></i> <a href="<?php echo site_url('admin/quiz'); ?>">Quiz</a> <i class="fa fa-angle-right"></i> <a href="<?php echo site_url('admin/quiz/paid'); ?>">Paid</a></h3>
               ...
               if (empty($quiz)) {
                  ...
                  echo '<h4>No Paid Quiz to display!</h4>';
                  echo '</div>';
                  echo '</div>';
                  echo '</div>';
               } else {
