...
<html lang="en">
   <head>
      ...
      <title>Quiz | <?php echo $site_title; ?> Dashboard</title>
      ...
      <section id="container" >         
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <h3 class="page-side-heading"><i class="fa fa-angle-right"></i> <a href="<?php echo site_url('admin/quiz'); ?>">Quiz</a></h3>
                  ...
                  <div class="col-lg-12">
                     ...
                     <div class="row mt">
                        <div class="col-md-4 col-sm-4 mb">
                           <a href="<?php echo site_url('admin/quiz/paid'); ?>">
                        ...
                        <div class="col-md-4 col-sm-4 mb">
                           <a href="<?php echo site_url('admin/quiz/free'); ?>">
                              <div class="twitter-panel pn">
                        ...
                        <div class="col-md-4 col-sm-4 mb">
                           <a href="<?php echo site_url('admin/quiz/archive'); ?>">
                              <div class="twitter-panel pn">
