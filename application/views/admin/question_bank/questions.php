...
<html lang="en">
   <head>
      ...
      <title>Question Bank - Questions | <?php echo $site_title; ?> Dashboard</title>
               ...
               <ul class="sidebar-menu" id="nav-accordion">
                 ...
                 <h5 class="centered"><?php echo ucwords($session['username']); ?></h5>
                  ...
                  <li class="sub-menu">
                     ...
                     <ul class="sub">
                        <li class="active"><a href="<?php echo site_url('admin/question_bank/questions'); ?>">Questions</a></li>
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <h3 class="page-side-heading">
                  <i class="fa fa-angle-right"></i> <a href="<?php echo site_url('admin/question_bank'); ?>">Question Bank</a> <i class="fa fa-angle-right"></i> <a href="<?php echo site_url('admin/question_bank/questions'); ?>">Questions</a>
               </h3>
               ...
               if (empty($questions)) {
                  ...
                  echo '<h4>No Questions to display in Question bank!</h4>';                  
                  echo '</div>';
                  echo '</div>';
                  echo '</div>';
               } else {
                  ...
                  foreach ($questions as $q) {
                     ...
                     echo '<h5>';
                     echo anchor(site_url('admin/question_bank/'.$q->id), $q->question);
                     ...
                     echo '<div class="btn-set">';
                     foreach ($questions_tags[$q->id] as $t) {
                        echo '<a href="'.site_url('admin/question_bank/tags/'.$t->tag_id).'"><span class="label label-info" style="margin-right: 3px;">'.ucwords($tag_list[$t->tag_id]).'</span></a>';
                     }
                     echo '</div>';
                     echo '</div>';
                     echo '</div>';
