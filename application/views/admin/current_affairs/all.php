         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <h3 class="page-side-heading">
                  <i class="fa fa-angle-right"></i> <a href="<?php echo site_url('admin/current_affairs/sort'); ?>">Current Affairs</a>
               </h3>
               ...
               if (empty($c_affairs)) {
                  ...
                  echo '<h4>No Current Affairs to display!</h4>';                  
                  echo '</div>';
                  echo '</div>';
                  echo '</div>';
               } else {
