         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <h3 class="page-side-heading">
                  <i class="fa fa-angle-right"></i> <a href="<?php echo site_url('admin/current_affairs/sort'); ?>">Current Affairs</a> <i class="fa fa-angle-right"></i> <a href="<?php echo site_url('admin/current_affairs/sort/'.$year); ?>"><?php echo $year; ?></a>
               </h3>

               <?php
               if (empty($c_affairs_y)) {
                  echo '<div class="row mt">';
                  echo '<div class="col-lg-12">';
                  echo '<div class="showback text-center">';
                  echo '<h4>No Current Affairs to display for '.$year.'!</h4>';                  
                  echo '</div>';
                  echo '</div>';
                  echo '</div>';
                  if($c_affairs_list) {
                     ...
                     echo '<div class="col-lg-12">';
                     echo '<div class="tags">';
                     foreach ($c_affairs_list as $year => $month) {
                        echo '<a href="'.site_url('admin/current_affairs/sort/'.$year).'"><span class="label label-warning">'.$year.'</span></a>';
                     }
                     echo '</div>';
                     echo '</div>';
                     echo '</div>';
