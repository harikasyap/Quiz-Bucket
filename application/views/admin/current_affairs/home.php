      ...
      <section id="container" >         
            ...
            <div id="sidebar"  class="nav-collapse ">
               <ul class="sidebar-menu" id="nav-accordion">
                 ...
                 <h5 class="centered"><?php echo ucwords($session['username']); ?></h5>
                  ...
                  <li class="sub-menu">
                     <a class="active" href="<?php echo site_url('admin/current_affairs'); ?>">
                        <i class="fa fa-check"></i>
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <h3 class="page-side-heading"><i class="fa fa-angle-right"></i> <a href="<?php echo site_url('admin/current_affairs'); ?>">Current Affairs</a></h3>
                  ...
                  <div class="col-lg-12">
                     ...
                     <div class="row mt">
                        <div class="col-md-4 col-sm-4 mb">
                           <a href="<?php echo site_url('admin/current_affairs/sort'); ?>">
                        ...
                        <div class="col-md-4 col-sm-4 mb">
                           <a href="<?php echo site_url('admin/current_affairs/edit'); ?>">
                              <div class="twitter-panel pn">
